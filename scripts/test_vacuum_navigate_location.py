...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--locations-file",
        default="drivers_sim/mujoco/assets/worlds/two_bedroom_apartment/locations.yaml",
    )
    return parser
...
def main() -> int:
    ...
    target = location["target_pose"]

    print(f"Navigating to {args.location}: x={target['x']}, y={target['y']}")
