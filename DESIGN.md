...
- `--robot-name panda` 会通过 Habitat-Sim articulated object API 加载 Panda URDF，暴露 `panda_arm`、`panda_hand`、`panda_arm_hand` 三个 joint model group，并支持 POSITION joint target；
